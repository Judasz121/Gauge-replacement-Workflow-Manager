...
namespace WorkflowManager.EFCoreLibrary.Migrations
{
    ...
    [Migration("20201015154237_InitialDBcreation")]
            ...
            modelBuilder.Entity("WorkflowManager.EFCoreLibrary.Entities.Job", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Duration = new TimeSpan(0, 1, 32, 46, 0),
                            IdBuilding = 1,
                            Name = "job1Name",
                            Order = 1,
                            PredictedDoneDate = new DateTime(2020, 10, 15, 21, 42, 36, 424, DateTimeKind.Local).AddTicks(4723)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            Done = false,
                            DoneDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Duration = new TimeSpan(0, 2, 22, 56, 0),
                            IdBuilding = 2,
                            Name = "job2Name",
                            Order = 2,
                            PredictedDoneDate = new DateTime(2020, 10, 15, 23, 42, 36, 429, DateTimeKind.Local).AddTicks(5641)
                        });
                });
            ...
            modelBuilder.Entity("WorkflowManager.EFCoreLibrary.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "e49015be-c88a-4f31-8b86-36342caed314",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "8cd87ab3-dadb-4992-9b7b-b55d447245c8",
                            ...
                            SecurityStamp = "503f663a-85d4-4124-9e55-1605ab0ec6dc",
                            TwoFactorEnabled = false
                        },
                        new
                        {
                            Id = "2e60f867-7a47-474a-8d3d-3b9bd509c814",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "ab99b1fd-16bb-42b1-9a86-e87d37a5f7c3",
                            EmailConfirmed = false,
                            FirstName = "Maciej",
                            LastName = "Waszalski",
                            Lock = false,
                            LockoutEnabled = false,
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "39cfc5ba-bdbb-4294-9693-3c87358f394d",
                            TwoFactorEnabled = false
                        });
                });
            ...
            modelBuilder.Entity("WorkflowManager.EFCoreLibrary.Entities.UserJob", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = "e49015be-c88a-4f31-8b86-36342caed314",
                            JobId = 2
                        },
                        new
                        {
                            UserId = "2e60f867-7a47-474a-8d3d-3b9bd509c814",
                            JobId = 1
                        });
                });
